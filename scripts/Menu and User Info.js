...
function LoadUserSettings() {//Read settings
  ...
  var Search = '';
  if (_MenuGetSetting(Range, 'Brian') == 'Enabled') {Search = Search+',1003'}
  if (_MenuGetSetting(Range, 'Stewie') == 'Enabled') {Search = Search+',1002'}
  if (_MenuGetSetting(Range, 'Louise') == 'Enabled') {Search = Search+',3002'}
  if (_MenuGetSetting(Range, 'Steve') == 'Enabled') {Search = Search+',2003'}
  if (_MenuGetSetting(Range, 'Bender') == 'Enabled') {Search = Search+',5016'}
  if (_MenuGetSetting(Range, 'Dale') == 'Enabled') {Search = Search+',4003'}
  if (_MenuGetSetting(Range, 'Bob') == 'Enabled') {Search = Search+',3001'}
  if (_MenuGetSetting(Range, 'Roger') == 'Enabled') {Search = Search+',2001'}
  if (_MenuGetSetting(Range, 'Leela') == 'Enabled') {Search = Search+',5018'}
  if (_MenuGetSetting(Range, 'Bobby') == 'Enabled') {Search = Search+',4002'}
  if (_MenuGetSetting(Range, 'Peter') == 'Enabled') {Search = Search+',1001'}
  if (_MenuGetSetting(Range, 'Tina') == 'Enabled') {Search = Search+',3003'}
  if (_MenuGetSetting(Range, 'Stan') == 'Enabled') {Search = Search+',2002'}
  if (_MenuGetSetting(Range, 'Fry') == 'Enabled') {Search = Search+',5017'}
  if (_MenuGetSetting(Range, 'Hank') == 'Enabled') {Search = Search+',4001'}
  if (_MenuGetSetting(Range, 'Consuela') == 'Enabled') {Search = Search+',1004'}
  if (_MenuGetSetting(Range, 'Ricky Spanish') == 'Enabled') {Search = Search+',2005'}
  if (_MenuGetSetting(Range, 'Gene') == 'Enabled') {Search = Search+',3304'}
  if (_MenuGetSetting(Range, 'Zapp Brannigan') == 'Enabled') {Search = Search+',5019'}
